...
namespace Board
{
    public class TetrisGridController : MonoBehaviour, IGridController
    {
        ...
        public bool PieceRotateLeft()
        {
            ...
            Debug.Log($"{BoardInfo.Instance.ActivePiece()} rotated left");
            return true;
        }
        ...
        public bool PieceRotateRight()
        {
            ...
            Debug.Log($"{BoardInfo.Instance.ActivePiece()} rotated right");
            return true;
        }
        ...
        public bool PieceShiftLeft()
        {
            ...
            Debug.Log($"{BoardInfo.Instance.ActivePiece()} shifted left");
            return true;
        }
        ...
        public bool PieceShiftRight()
        {
            ...
            Debug.Log($"{BoardInfo.Instance.ActivePiece()} shifted right");
            return true;
        }
        ...
        public bool PieceShiftDown()
        {
            ...
            Debug.Log($"{BoardInfo.Instance.ActivePiece()} shifted down");
            return true;
        }
